...
source("IndepthPathway.modules_v2.8.5.R")
...
gctFile="./scDataset/scData_quiescentVsActive.gct"
clsFile="./scDataset/scData_quiescentVsActive.cls"
####################################################################################################################
...
up.disambiguate<-disambiguation.CSEA(GEA.result=up.CSEA.result,uniConSig.result=uniConSig.result,compare.list=compare.list,upPathways=TRUE,
...
down.disambiguate<-disambiguation.CSEA(GEA.result=down.CSEA.result,uniConSig.result=uniConSig.result,compare.list=compare.list,upPathways=FALSE,
